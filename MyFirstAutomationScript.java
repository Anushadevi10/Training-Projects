...
public class MyFirstAutomationScript {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		*/
        ...
        driver.findElement(By.id("first_name")).sendKeys("Anusha Devi");
        driver.findElement(By.id("last_name")).sendKeys("Manoharan");
        driver.findElement(By.id("address")).sendKeys("F2 Ragavendra apartment,Perumbakkam, Chennai");
        driver.findElement(By.id("cc_num")).sendKeys("123455678904325");
        new Select(driver.findElement(By.id("cc_type"))).selectByValue("VISA");
        new Select(driver.findElement(By.id("cc_exp_month"))).selectByValue("7");
        new Select(driver.findElement(By.id("cc_exp_year"))).selectByValue("2024");
        driver.findElement(By.id("cc_cvv")).sendKeys("888");
